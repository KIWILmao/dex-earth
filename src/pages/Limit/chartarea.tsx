...
import { widget, LanguageCode, ResolutionString } from '../../charting_library';
...
export default function ChartArea({ symbol, fullscreen }: any) {
  ...
  }, [chartContainerRef, fullscreen]);

  return <ChartWrapper ref={chartContainerRef} className={'TVChartContainer'}></ChartWrapper>;
}
